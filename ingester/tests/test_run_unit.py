...
def test_should_create_readonly_returns_false_when_stat_unchanged(tmp_path):
...
def test_update_or_delete_raises_file_not_found_when_db_missing(subcommand, tmp_path):
